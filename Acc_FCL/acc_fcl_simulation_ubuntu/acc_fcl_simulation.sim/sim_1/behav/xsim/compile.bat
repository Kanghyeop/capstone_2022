...
REM
REM Generated by Vivado on Tue Aug 30 16:27:33 +0900 2022
...
echo "xvlog --incr --relax -prj tb_data_mover_bram_vlog.prj"
call xvlog  --incr --relax -prj tb_data_mover_bram_vlog.prj -log xvlog.log
